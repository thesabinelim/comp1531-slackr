...
def test_search_none():
    ...
    message_send(reg_dict1['token'], channel_1['channel_id'], "Hello there!")
    message_send(reg_dict2['token'], channel_1['channel_id'], "Hello")
    message_send(reg_dict3['token'], channel_1['channel_id'], "hi everyone")
...
def test_search_space():
    ...
    message_send(reg_dict1['token'], channel_1['channel_id'], "Hello there!")
    message_send(reg_dict2['token'], channel_1['channel_id'], "Hello")
    message_send(reg_dict3['token'], channel_1['channel_id'], "Hello everyone")
...
def test_search_multi_channel():
    ...
    message_send(reg_dict1['token'], channel_2['channel_id'], "Hello there!")
    message_send(reg_dict2['token'], channel_1['channel_id'], "Hello")
